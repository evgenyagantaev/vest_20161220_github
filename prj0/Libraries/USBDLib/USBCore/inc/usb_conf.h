...
/****************** USB OTG FS CONFIGURATION **********************************/
 ...
 #define RX_FIFO_FS_SIZE                          96   //128
 #define TX0_FIFO_FS_SIZE                          64   //64
 #define TX1_FIFO_FS_SIZE                         96   //128
 #define TX2_FIFO_FS_SIZE                          0    //0
 #define TX3_FIFO_FS_SIZE                          0   //0
 #define TXH_NP_HS_FIFOSIZ                         64 //96
 #define TXH_P_HS_FIFOSIZ                          64 //96
